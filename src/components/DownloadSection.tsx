  ...
  return (
    <section id="telecharger" className="relative py-24 bg-foreas-deepblack overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        >
          {/* App Store — 21/08/2026 : ce lien pointait sur « # » sous une pastille
              « BIENTÔT », alors que la fiche répond 200 depuis les boutiques.
              Le site disait « bientôt » d'une app DÉJÀ PUBLIÉE, et n'offrait
              aucun moyen de l'installer. Adresse prise dans src/lib/app-stores.ts,
              jamais recopiée : recopier, c'est créer un deuxième endroit à
              corriger le jour où l'identifiant change. */}
          <a
            href={APP_STORE_URL}
            target="_blank"
          ...
          >
            ...
            <div className="text-left">
              <p className="text-white/50 text-xs">Télécharger sur</p>
              <p className="text-white font-semibold">App Store</p>
            </div>
          </a>

          {/* Play Store — même correction, même raison. */}
          <a
            href={PLAY_STORE_URL}
            target="_blank"
            rel="noopener noreferrer"
