  ...
  return (
    <section className="relative py-16 sm:py-24 px-4 border-y border-white/[0.06]">
      ...
      <div className="relative max-w-3xl mx-auto">
        ...
        >
          <p
            className="text-rose-300/85 t-eyebrow mb-3"
        ...
        >
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between mb-2">
              <p
                className="text-white/55 t-eyebrow"
                style={{ letterSpacing: '0.2em' }}
              >
                Course brute
              </p>
              <p
                className="t-display-m text-[#F8FAFC] tabular-nums"
          ...
          >
            <p
              className="text-[#EF4444]/90 t-eyebrow flex items-center gap-2 mb-1.5"
              style={{ letterSpacing: '0.2em' }}
            >
            ...
            <p
              className="t-display-xxl text-[#EF4444] tabular-nums leading-none"
              style={{ letterSpacing: '-0.04em' }}
            >
              −{breakdown.commission.toFixed(2).replace('.', ',')}&nbsp;€
            </p>
            <p className="text-white/45 t-caption mt-2">
          ...
          <div className="flex items-center justify-between">
            <p
              className="text-white/65 t-eyebrow"
              style={{ letterSpacing: '0.2em' }}
            >
              Ce qu'il te reste dans la poche
            </p>
            <p
              className="t-display-m text-white/80 tabular-nums"
              style={{ letterSpacing: '-0.03em' }}
            >
