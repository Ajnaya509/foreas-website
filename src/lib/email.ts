  ...
  return `
      <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:36px;">
        <tr><td style="background-color:#0e0e16;border:1px solid #2a2a3a;border-radius:14px;padding:24px;">
          ...
          <div style="font-family:'Inter',sans-serif;font-size:11px;color:#BCC5D4;letter-spacing:0.5px;margin-bottom:5px;">EMAIL</div>
          <div style="font-family:'Inter',sans-serif;font-size:15px;color:#F8FAFC;font-weight:600;margin-bottom:18px;word-break:break-all;">${escapeHtml(email)}</div>

          <div style="font-family:'Inter',sans-serif;font-size:11px;color:#BCC5D4;letter-spacing:0.5px;margin-bottom:5px;">MOT DE PASSE</div>
          ...
          <div style="font-family:'Inter',sans-serif;font-size:12px;color:#BCC5D4;line-height:1.6;margin-top:18px;padding-top:16px;border-top:1px solid #1e1e2a;">
  ...
  return `
      <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:36px;">
        <tr><td style="background-color:#0e0e16;border:1px solid #2a2a3a;border-radius:14px;padding:24px;">
          ...
          <div style="font-family:'Inter',sans-serif;font-size:13px;color:#BCC5D4;line-height:1.6;">
...
function buildWelcomeHTML({ name, plan, trialEnd, trialActive, credentials, dejaInscrit }: {
  name: string; plan: string; trialEnd: string | null; trialActive?: boolean
  ...
  const trialLabel = trialActive === true && trialEnd ? escapeHtml(trialEnd) : null
  // Genos = titres (font-weight 600), Genos italic = taglines, Inter = body
...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Genos:ital,wght@0,400;0,600;0,700;1,400;1,500&family=Inter:wght@400;500;600&display=swap" rel="stylesheet">
</head>
<body style="margin:0;padding:0;background-color:#050508;">
  <div style="max-width:600px;margin:0 auto;padding:0;">
    ...
    <div style="background-color:#050508;padding:40px 28px;">
      ...
      <!-- Sous-titre en Inter — gris doux -->
      <p style="font-family:'Inter',sans-serif;font-size:14px;color:#BCC5D4;text-align:center;margin:0 0 36px;line-height:1.6;">
        ${trialLabel ? 'Ton essai FOREAS est actif.' : 'Ton abonnement FOREAS est enregistr&eacute;.'}
      </p>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td style="padding-bottom:16px;border-bottom:1px solid #18182a;">
                  <div style="font-family:'Inter',sans-serif;font-size:10px;color:#BCC5D4;text-transform:uppercase;letter-spacing:2px;margin-bottom:8px;">Ton plan</div>
                  <div style="font-family:'Genos',sans-serif;font-size:22px;font-weight:600;color:#ffffff;">${escapeHtml(plan)}</div>
                </td>
              </tr>
              <tr>
                <td style="padding-top:16px;">
                  <div style="font-family:'Inter',sans-serif;font-size:13px;color:#BCC5D4;line-height:1.8;">
                    ${trialLabel ? `Ton essai se termine le ${trialLabel}.<br/>Consulte ton abonnement pour retrouver le d&eacute;tail des paiements.` : 'Consulte ton abonnement pour retrouver ta formule et le d&eacute;tail des paiements.'}
                  </div>
                </td>
              </tr>
            </table>
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:32px;">
        <tr><td style="padding:0 4px;">
          <div style="font-family:'Inter',sans-serif;font-size:15px;line-height:1.65;color:#F8FAFC;">
            Retrouve Ajnaya dans l&rsquo;app pour pr&eacute;parer ta journ&eacute;e
            et retrouver tes informations de conduite.
          </div>
          <div style="font-family:'Inter',sans-serif;font-size:13px;line-height:1.6;color:#BCC5D4;margin-top:8px;">
      ...
      <p style="margin:0 0 32px;font-family:'Inter',sans-serif;font-size:12px;line-height:1.6;color:#BCC5D4;text-align:center;">
        Mot de passe perdu&nbsp;? <a href="https://partners.foreas.xyz/auth/reset" style="color:#F8FAFC;">Re&ccedil;ois-en un nouveau</a>. Une question&nbsp;? R&eacute;ponds &agrave; ce mail, on lit tout.
      </p>

      <!-- Store links — gris discret -->
      <p style="text-align:center;font-family:'Inter',sans-serif;font-size:11px;color:#BCC5D4;margin:0 0 40px;">
        <a href="${APP_STORE_URL}" style="color:#BCC5D4;text-decoration:none;">App Store</a>
        <span style="color:#2a2a3a;"> &nbsp;&middot;&nbsp; </span>
        <a href="${PLAY_STORE_URL}" style="color:#BCC5D4;text-decoration:none;">Google Play</a>
      </p>

      <!-- ═══ NEXT STEPS — minimaliste ═══ -->
      <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:36px;">
        <tr><td style="padding:0;">
          <div style="font-family:'Genos',sans-serif;font-size:14px;font-weight:600;color:#BCC5D4;letter-spacing:1.5px;margin-bottom:18px;">PROCHAINES &Eacute;TAPES</div>
          <table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
            <tr>
              <td style="width:24px;vertical-align:top;padding-right:14px;padding-bottom:16px;">
                <div style="width:24px;height:24px;border-radius:50%;background-color:#0e0e16;border:1px solid #2a2a3a;color:#BCC5D4;font-family:'Genos',sans-serif;font-size:12px;font-weight:600;text-align:center;line-height:24px;">1</div>
              </td>
              <td style="font-family:'Inter',sans-serif;font-size:13px;color:#BCC5D4;padding-bottom:16px;line-height:1.5;">T&eacute;l&eacute;charge l&rsquo;app et connecte-toi${credentials ? ' avec les identifiants ci-dessus' : dejaInscrit ? ' avec ton mot de passe habituel' : ''}</td>
            </tr>
            <tr>
              <td style="width:24px;vertical-align:top;padding-right:14px;padding-bottom:16px;">
                <div style="width:24px;height:24px;border-radius:50%;background-color:#0e0e16;border:1px solid #2a2a3a;color:#BCC5D4;font-family:'Genos',sans-serif;font-size:12px;font-weight:600;text-align:center;line-height:24px;">2</div>
              </td>
              <td style="font-family:'Inter',sans-serif;font-size:13px;color:#BCC5D4;padding-bottom:16px;line-height:1.5;">D&eacute;couvre les fonctions de l&rsquo;app avec Ajnaya</td>
            </tr>
            <tr>
              <td style="width:24px;vertical-align:top;padding-right:14px;">
                <div style="width:24px;height:24px;border-radius:50%;background-color:#0e0e16;border:1px solid #2a2a3a;color:#BCC5D4;font-family:'Genos',sans-serif;font-size:12px;font-weight:600;text-align:center;line-height:24px;">3</div>
              </td>
              <td style="font-family:'Inter',sans-serif;font-size:13px;color:#BCC5D4;line-height:1.5;">Roule comme d&rsquo;habitude. C&rsquo;est en roulant qu&rsquo;elle apprend</td>
            </tr>
          </table>
        </td></tr>
      </table>
    ...
    <div style="padding:24px 28px;text-align:center;border-top:1px solid #12121e;">
      <p style="font-family:'Inter',sans-serif;font-size:12px;color:#BCC5D4;margin:0 0 8px;line-height:1.6;">
        Des questions ?
        <a href="mailto:contact@foreas.xyz" style="color:#BCC5D4;text-decoration:none;">contact@foreas.xyz</a>
      </p>
      <p style="font-family:'Genos',sans-serif;font-style:italic;font-size:12px;color:#BCC5D4;margin:0 0 10px;">Toujours plus loin.</p>
      <p style="font-family:'Inter',sans-serif;font-size:12px;color:#BCC5D4;margin:0;">
        FOREAS &middot;
        <a href="https://foreas.xyz/unsubscribe" style="color:#BCC5D4;text-decoration:underline;">Se d&eacute;sabonner</a>
      </p>
    </div>
...
export async function sendWelcomeEmailReceipt({ email, name, plan, trialEnd, trialActive, credentials, dejaInscrit, deliveryKey }: {
  email: string; name: string; plan: string; trialEnd: string | null
  trialActive?: boolean
  deliveryKey?: string
  ...
  dejaInscrit?: { email: string } | null
}): Promise<{ accepted: boolean; providerId?: string | null }> {
  if (!resend) {
  ...
  try {
      ...
      html: buildWelcomeHTML({ name, plan, trialEnd, trialActive, credentials, dejaInscrit }),
      ...
      if (error || !data?.id) {
        ...
        console.error(`[Email] ÉCHEC welcome email : ${error?.name || 'missing_receipt'}`)
        return { accepted: false }
      }
...
export async function sendWelcomeEmail(input: Parameters<typeof sendWelcomeEmailReceipt>[0]): Promise<boolean> {
  return (await sendWelcomeEmailReceipt(input)).accepted
}
 ...
 */
function foreasEmailShell(inner: string, brandLabel = "FOREAS Labs · Paris"): string {
  if (brandLabel === 'FOREAS') return `<!DOCTYPE html><html lang="fr"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><link href="https://fonts.googleapis.com/css2?family=Genos:wght@600;700&family=Inter:wght@400;500;600&display=swap" rel="stylesheet"></head>
<body style="margin:0;padding:0;background-color:#060610;color:#F8FAFC;">
...
<div style="padding:24px;border-top:1px solid #293247;font-family:Inter,Arial,sans-serif;font-size:14px;color:#BCC5D4;line-height:1.6;">
<p style="margin:0;">FOREAS · Toujours plus loin.</p><p style="margin:8px 0 0;"><a href="mailto:contact@foreas.xyz" style="color:#F8FAFC;text-decoration:underline;">contact@foreas.xyz</a></p>
</div></div></body></html>`
...
<div style="max-width:600px;margin:0 auto;">
  ...
  <div style="padding:24px 28px;text-align:center;border-top:1px solid #12121e;">
    ...
    <p style="font-family:'Montserrat',sans-serif;font-size:9px;color:#1e1e2a;margin:8px 0 0;">${escapeHtml(brandLabel)} · <a href="mailto:contact@foreas.xyz" style="color:#3a3a4a;text-decoration:none;">contact@foreas.xyz</a></p>
  </div>
</div></body></html>`
}

/** Email à l'APPLICANT : "Ta demande de partenariat FOREAS est bien reçue". */
export async function sendPartnerApplicantEmail({ email, contactName, companyName, reference }: {
  email: string; contactName: string; companyName: string; reference?: string
}): Promise<{ accepted: boolean; providerId?: string | null }> {
  if (!resend) return { accepted: false }
  const firstName = contactName ? escapeHtml(contactName.split(' ')[0]) : ''
  const inner =
    '<h1 style="font-family:Genos,sans-serif;font-size:28px;color:#F8FAFC;">Demande reçue' + (firstName ? ', ' + firstName : '') + '.</h1>' +
    '<p style="font-family:Inter,Arial,sans-serif;font-size:15px;color:#F8FAFC;line-height:1.7;">Ta candidature pour <strong>' + escapeHtml(companyName) + '</strong> est enregistrée. FOREAS va étudier ton activité avant de te proposer les conditions du partenariat.</p>' +
    (reference ? '<p style="font-family:Inter,Arial,sans-serif;font-size:14px;color:#F8FAFC;">Ta référence : <strong>' + escapeHtml(reference) + '</strong></p>' : '') +
    '<p style="font-family:Inter,Arial,sans-serif;font-size:14px;color:#F8FAFC;line-height:1.7;">L’enregistrement ne vaut pas encore admission. Si ta demande est acceptée, tu recevras les instructions pour accéder à ton espace partenaire.</p>' +
    '<p style="font-family:Inter,Arial,sans-serif;font-size:14px;color:#F8FAFC;line-height:1.7;">Une question ? Réponds à cet email en conservant ta référence.</p>'
  try {
    const result = await resend.emails.send({
      from: 'FOREAS <noreply@foreas.xyz>', replyTo: 'contact@foreas.xyz', to: email,
      subject: 'Ta candidature partenaire FOREAS est reçue', html: foreasEmailShell(inner, "FOREAS"),
    }, reference ? { idempotencyKey: 'partner-application-applicant/' + reference } : undefined)
    return { accepted: !result.error && !!result.data?.id, providerId: result.error ? null : result.data?.id }
  } catch {
    console.error('[Email] Confirmation partenaire non acceptée par le service d’envoi')
    return { accepted: false }
  }
}
...
/**
 * Alerte interne de facturation à vérifier.
 * ⚠️ 17/09/2026 — le titre disait « Chauffeur payant sans compte » et « le paiement est
 * passé » pour TOUS les cas, y compris un essai à 0 € ou un simple rebond de courrier.
 * Une alerte ne dit jamais « payé » : seul Stripe le prouve (montant réellement encaissé).
 * Vocabulaire commun : CHECKOUT COMMENCÉ / TERMINÉ, ESSAI ACTIF, ABONNEMENT ACTIF PAYÉ,
 * PAIEMENT ÉCHOUÉ, ANNULÉ, NON RATTACHÉ, ERREUR SYNC.
...
export async function sendProvisionFailureAlert({ email, name, reason, sujet }: {
  ...
  const inner = `
    <h1 style="font-family:'Genos',sans-serif;font-size:24px;font-weight:600;color:#EF4444;margin:0 0 6px;">Facturation &agrave; v&eacute;rifier</h1>
    <p style="font-family:'Montserrat',sans-serif;font-size:13px;color:#8888a0;margin:0 0 24px;">Un &eacute;v&eacute;nement de facturation n&rsquo;a pas pu &ecirc;tre trait&eacute; jusqu&rsquo;au bout. Ce message ne prouve aucun encaissement : un essai = 0&nbsp;&euro; encaiss&eacute;. V&eacute;rifier le statut et le montant r&eacute;el dans Stripe.</p>
  ...
  try {
    await resend.emails.send({
      ...
      subject: sujet ?? `⚠️ ERREUR SYNC facturation : ${email}`,
...
export async function sendPartnerInternalEmail(app: {
  companyName: string; contactName: string; email: string; phone?: string; siret?: string;
  message?: string; category?: string; professionalUrl?: string; territory?: string;
  collaborationMode?: string; reference?: string
}): Promise<{ accepted: boolean; providerId?: string | null }> {
  if (!resend) return { accepted: false }
  // Server setting only. An isolated environment can use an official test inbox.
  // An invalid explicit setting must never fall back to the real recipient.
  const recipient = (process.env.PARTNER_APPLICATION_ALERT_EMAIL ?? 'contact@foreas.xyz').trim()
  if (!/^[^\s@,;<>]+@[^\s@,;<>]+\.[^\s@,;<>]+$/.test(recipient)) return { accepted: false }
  const adminUrl = (process.env.NEXT_PUBLIC_DASHBOARD_URL || DASH_DEFAUT).replace(/\/$/, '') + '/admin/partner-pending'
  const row = (name: string, value?: string) => value
    ? '<tr><th style="text-align:left;padding:8px;color:#F8FAFC;">' + name + '</th><td style="padding:8px;color:#F8FAFC;">' + escapeHtml(value) + '</td></tr>' : ''
  const inner = '<h1 style="font-family:Genos,sans-serif;font-size:26px;color:#F8FAFC;">Nouvelle candidature partenaire</h1>' +
    '<table style="font-family:Inter,Arial,sans-serif;font-size:14px;">' +
    row('Référence', app.reference) + '</table>' +
    '<p style="font-family:Inter,Arial,sans-serif;color:#F8FAFC;">Les informations du candidat sont disponibles dans le dossier protégé.</p>' +
    '<p><a style="color:#B494FF;font-family:Inter,Arial,sans-serif;" href="' + escapeHtml(adminUrl) + '">Étudier la candidature dans l’administration</a></p>'
  try {
    const result = await resend.emails.send({
      from: 'FOREAS <noreply@foreas.xyz>', to: recipient,
      subject: 'Nouvelle candidature partenaire FOREAS', html: foreasEmailShell(inner, "FOREAS"),
    }, app.reference ? { idempotencyKey: 'partner-application-internal/' + app.reference } : undefined)
    return { accepted: !result.error && !!result.data?.id, providerId: result.error ? null : result.data?.id }
  } catch {
    console.error('[Email] Alerte partenaire non acceptée par le service d’envoi')
    return { accepted: false }
  }
}
