      ...
      <main className="min-h-screen bg-[#050508] text-white">
        ...
        <section className="relative overflow-hidden px-6 py-16 md:py-24">
          ...
          <div className="relative mx-auto max-w-4xl">
            ...
            <p className="text-lg md:text-xl text-white/70 leading-relaxed max-w-3xl mb-8">
              ...
              <strong className="text-white">recevoir des factures électroniques</strong> de leurs fournisseurs. FOREAS intègre une{' '}
              <strong className="text-white">Plateforme Agréée DGFiP</strong> directement dans l&apos;app : tu continues à travailler, on branche la plomberie.
            </p>
        ...
        <section className="px-6 py-24 border-t border-white/5 bg-gradient-to-br from-[#00D4FF]/5 to-[#8C52FF]/10">
          <div className="mx-auto max-w-3xl text-center">
            ...
            >
              ...
              <br />
              <span className="text-[#00D4FF]">Zéro stress avec FOREAS.</span>
            </h2>
        ...
        <footer className="px-6 py-12 border-t border-white/10 text-sm text-white/50">
          <div className="mx-auto max-w-4xl space-y-4">
            <p>
              <strong className="text-white/80">FOREAS Labs</strong> — contact@foreas.net — FOREAS est un copilote IA, pas un cabinet d&apos;expertise comptable. Pour toute certification officielle (déclaration fiscale signée, contrôle, conseil juridique), nous orientons vers un expert-comptable partenaire inscrit à l&apos;Ordre.
            </p>
            <p>
