        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <div className="p-5 md:p-6 bg-white/[0.02] border border-white/[0.06] rounded-2xl">
              <h2 className="font-title text-lg md:text-xl font-semibold text-white/90 mb-3">1. Objet</h2>
            ...
            <div className="p-5 md:p-6 bg-white/[0.02] border border-white/[0.06] rounded-2xl">
              <h2 className="font-title text-lg md:text-xl font-semibold text-white/90 mb-3">2. Acceptation des conditions</h2>
              <p className="font-sans text-sm md:text-base text-white/65 leading-relaxed">
            ...
            <div className="p-5 md:p-6 bg-white/[0.02] border border-white/[0.06] rounded-2xl">
              <h2 className="font-title text-lg md:text-xl font-semibold text-white/90 mb-3">3. Accès et inscription</h2>
              <p className="font-sans text-sm md:text-base text-white/65 leading-relaxed">
              ...
              <p className="font-sans text-sm md:text-base text-white/65 leading-relaxed mt-3">
                L&apos;Utilisateur est seul responsable de la confidentialité de ses identifiants de connexion. Toute utilisation du Service depuis son compte est réputée effectuée par l&apos;Utilisateur. En cas de compromission de son compte, il doit en informer FOREAS sans délai à l&apos;adresse <span className="text-white/80">contact@foreas.xyz</span>.
              </p>
            </div>

            <div className="p-5 md:p-6 bg-white/[0.02] border border-white/[0.06] rounded-2xl">
              <h2 className="font-title text-lg md:text-xl font-semibold text-white/90 mb-3">4. Description du Service</h2>
              <p className="font-sans text-sm md:text-base text-white/65 leading-relaxed">
            ...
            <div className="p-5 md:p-6 bg-white/[0.02] border border-white/[0.06] rounded-2xl">
              <h2 className="font-title text-lg md:text-xl font-semibold text-white/90 mb-3">5. Obligations de l&apos;Utilisateur</h2>
              <p className="font-sans text-sm md:text-base text-white/65 leading-relaxed">L&apos;Utilisateur s&apos;engage à :</p>
              <ul className="mt-3 space-y-2.5 list-none">
                <li className="pl-4 border-l border-white/15 font-sans text-sm md:text-base text-white/65 leading-relaxed">Utiliser le Service conformément à la réglementation en vigueur, notamment le Code des transports et les règles applicables à sa profession ;</li>
                <li className="pl-4 border-l border-white/15 font-sans text-sm md:text-base text-white/65 leading-relaxed">Ne jamais utiliser l&apos;application de manière à mettre en danger sa sécurité ou celle des tiers — toute interaction avec l&apos;application pendant la conduite doit se limiter aux fonctions mains libres et aux commandes vocales ;</li>
                <li className="pl-4 border-l border-white/15 font-sans text-sm md:text-base text-white/65 leading-relaxed">Ne pas reproduire, copier, vendre, revendre ou exploiter le Service à des fins commerciales sans autorisation écrite préalable de FOREAS ;</li>
                <li className="pl-4 border-l border-white/15 font-sans text-sm md:text-base text-white/65 leading-relaxed">Ne pas tenter de contourner, désactiver ou interférer avec les mécanismes de sécurité du Service ;</li>
                <li className="pl-4 border-l border-white/15 font-sans text-sm md:text-base text-white/65 leading-relaxed">Ne pas utiliser de systèmes automatisés (bots, scrapers) pour accéder au Service.</li>
              </ul>
            </div>
            ...
            <div className="p-5 md:p-6 bg-white/[0.02] border border-white/[0.06] rounded-2xl">
              ...
              <p className="font-sans text-sm md:text-base text-white/65 leading-relaxed mt-3">
                La responsabilité de FOREAS ne saurait excéder, pour quelque cause que ce soit, le montant des sommes effectivement versées par l&apos;Utilisateur au cours des 3 derniers mois précédant le fait générateur.
              </p>
            </div>
            ...
            <div className="p-5 md:p-6 bg-white/[0.02] border border-white/[0.06] rounded-2xl">
              ...
              <p className="font-sans text-sm md:text-base text-white/65 leading-relaxed">
                Pour toute question relative aux présentes CGU : <span className="text-white/80">contact@foreas.xyz</span>
              </p>
              <p className="font-sans text-sm md:text-base text-white/55 leading-relaxed mt-2">
