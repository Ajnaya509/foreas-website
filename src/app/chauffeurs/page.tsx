...
function MicroDetail({ icon: Icon, title, desc, stat, delay = 0 }: {
  ...
  return (
    <div className="group flex-shrink-0 w-[280px] md:w-[360px] p-5 md:p-6 rounded-2xl border border-white/[0.05] bg-[#0D1526]/95 md:bg-white/[0.03] md:backdrop-blur-sm hover:border-accent-cyan/20 transition-all">
  ...
  return (
    <main className="min-h-screen bg-[#080C18]">
      ...
      {/* ═══════════════════════════════════════════════════════════════
          ...
          ═══════════════════════════════════════════════════════════════ */}
      <section id="douleur" data-section="duality" className="relative py-20 md:py-28 bg-[#0D1526]">
      ...
      {/* ═══════════════════════════════════════════════════════════════
          ...
          ═══════════════════════════════════════════════════════════════ */}
      <section data-section="features" className="relative bg-[#0D1526]">
      ...
      <section data-section="offer" className="relative py-32 lg:py-40 overflow-hidden">
        <motion.div
          ...
          className="absolute inset-0 bg-[#080C18]"
        />
