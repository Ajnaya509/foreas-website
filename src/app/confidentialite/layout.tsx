...
/**
 * Métadonnées de /confidentialite.
 *
...
export const metadata: Metadata = metadonneesPage(
  '/confidentialite',
  "Politique de confidentialité — FOREAS",
  'Quelles données FOREAS collecte, pourquoi, combien de temps, et comment exercer tes droits.',
)
