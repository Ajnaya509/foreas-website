          ...
          >
            ...
            <div className="p-5 md:p-6 bg-white/[0.02] border border-white/[0.06] rounded-2xl">
              ...
              <div className="p-4 bg-white/[0.03] rounded-xl space-y-1.5">
                <p className="font-sans text-sm md:text-base text-white/65"><span className="text-white/45">Dénomination :</span> <span className="text-white/85">EPHIALTES</span></p>
                <p className="font-sans text-sm md:text-base text-white/65"><span className="text-white/45">SIREN :</span> <span className="text-white/85">940 879 281</span></p>
                <p className="font-sans text-sm md:text-base text-white/65"><span className="text-white/45">Adresse :</span> 58 rue de Monceau, 75008 Paris, France</p>
              ...
              <p className="font-sans text-sm md:text-base text-white/65 leading-relaxed mt-4">
                Le directeur de la publication est le représentant légal de EPHIALTES.
              </p>
            </div>
            ...
            <div className="p-5 md:p-6 bg-white/[0.02] border border-white/[0.06] rounded-2xl">
              ...
              <p className="font-sans text-sm md:text-base text-white/65 leading-relaxed mt-3">
                Responsable du traitement : EPHIALTES — <span className="text-white/80">contact@foreas.xyz</span>
              </p>
            </div>
            ...
            <div className="p-5 md:p-6 bg-white/[0.02] border border-white/[0.06] rounded-2xl">
              ...
              <p className="font-sans text-sm md:text-base text-white/65 leading-relaxed">
                Le site foreas.xyz peut contenir des liens vers des sites tiers. EPHIALTES n&apos;exerce aucun contrôle sur ces sites et décline toute responsabilité quant à leur contenu, leur disponibilité ou leurs pratiques en matière de protection des données.
              </p>
              <p className="font-sans text-sm md:text-base text-white/65 leading-relaxed mt-3">
                La création de liens hypertextes vers foreas.xyz est autorisée sous réserve de ne pas porter atteinte à l&apos;image de EPHIALTES.
              </p>
            </div>
            ...
            <div className="p-5 md:p-6 bg-white/[0.02] border border-white/[0.06] rounded-2xl">
              ...
              <p className="font-sans text-sm md:text-base text-white/65 leading-relaxed">
                EPHIALTES s&apos;efforce d&apos;assurer l&apos;exactitude des informations publiées sur foreas.xyz, sans toutefois garantir leur exhaustivité. EPHIALTES ne saurait être tenu responsable des dommages directs ou indirects résultant de l&apos;accès au site ou de l&apos;impossibilité d&apos;y accéder.
              </p>
            </div>
            ...
            <div className="p-5 md:p-6 bg-white/[0.02] border border-white/[0.06] rounded-2xl">
              ...
              <div className="mt-1 p-4 bg-white/[0.03] rounded-xl space-y-1.5">
                <p className="font-sans text-sm md:text-base text-white/65"><span className="text-white/45">E-mail :</span> <span className="text-white/85">contact@foreas.xyz</span></p>
                <p className="font-sans text-sm md:text-base text-white/65"><span className="text-white/45">Société :</span> EPHIALTES — SIREN 940 879 281 — France</p>
              </div>
            </div>
