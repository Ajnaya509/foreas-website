...
import { MENTION_DEMONSTRATION } from '@/lib/donneesDemo'
    ...
    <div className="min-h-screen bg-[#050508] flex">
        ...
        <div className="px-4 py-5">
          <div className="flex items-center gap-3 px-2">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-white/90 text-sm font-medium truncate">Camille</p>
      ...
      <div className="flex-1 flex flex-col min-h-screen relative z-10">
        ...
        <main className="flex-1 p-5 md:p-8 lg:p-10">
          {/*
            ⚠️ 21/08/2026 — CETTE MENTION N'EST PAS DÉCORATIVE.

            Avant, cette console publique affichait « Nikolic D. — En course —
            Bastille — 22,10 €/h » : les noms de six chauffeurs RÉELS, ceux-là
            mêmes qui ont accepté d'être filmés, avec une zone, un statut
            d'activité et un revenu horaire entièrement inventés. Sur une page
            que n'importe qui pouvait ouvrir sans mot de passe.

            Les noms sont partis (voir src/lib/donneesDemo.ts). Reste le second
            problème : rien ne disait qu'il s'agissait d'une maquette. Une donnée
            inventée qui ne s'annonce pas est une donnée fausse ; une donnée
            inventée qui s'annonce est une illustration.
          */}
          <p className="mb-4 rounded-lg border border-amber-400/25 bg-amber-400/[0.07] px-4 py-2.5 text-[12px] leading-relaxed text-amber-200/80">
